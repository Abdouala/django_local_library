...
class Book(models.Model):
    ...
    # La clé étrangère (ForeignKey) est utilisée car elle représente correcte le modèle de relation en livre et son
    # auteur : Un livre a un seul auteur, mais un auteur a écrit plusieurs livres. Le type de l'objet Author est
    # déclré comme une chaîne de caractère car la classe d'objet Author n'a pas encore été déclarée dans le fichier
...
class Language(models.Model):
    name = models.CharField(
        max_length=200,
        help_text='Enter the language of the book (e.g. English, French ...)',
        null=True,
        blank=True
    )
